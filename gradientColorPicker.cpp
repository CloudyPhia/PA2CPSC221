...
HSLAPixel gradientColorPicker::operator()(int x, int y)
{
    ...
    if (d > r) return color2;

    if (color2.h > color1.h && (color2.h - color1.h) < 180) {
        color.h = color1.h - (d/r) * (360 - color2.h + color1.h);
    } else if (color2.h > color1.h && (color2.h - color1.h >= 180)) {
        color.h = color1.h + (d/r) * (color2.h - color1.h);
    } else if (color1.h > color2.h && (color1.h - color2.h < 180)) {
